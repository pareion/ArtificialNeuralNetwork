...
using ArtificialNeuralNetwork.TrainingType;
...
namespace ArtificialNeuralNetwork.Network
{
    public class NeuralNet : INeuralNet
    {
        ...
        public void Train(double[][] inputs, double[][] expected, TrainingType.TrainingType type, int iterations)
        {
            int i, j;

            switch (type)
            {
                case TrainingType.TrainingType.BackPropogation:
